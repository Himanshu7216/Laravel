...
<div id="errorNotification" class="alert alert-danger text-center">
  ...
  <main>
    <div class="container mt-5">
      <form id="addCategoryForm" action="/categories/add" method="post" autocomplete="off">
        @csrf
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="description" name="description" rows="3" isvalid="false" placeholder="Enter description here.." maxlength="1000"></textarea>
